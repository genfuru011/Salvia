    ...
    <turbo-frame id={`todo_${todo.id}`}>
      <div class="flex items-center justify-between p-4 bg-gray-50 rounded-lg group hover:bg-gray-100 transition-colors mb-2">
        <div class="flex items-center gap-3">
          <form action={`/todos/${todo.id}/toggle`} method="post" data-turbo-frame="_top" class="m-0">
        ...
        <form action={`/todos/${todo.id}/delete`} method="post" data-turbo-frame="_top" class="m-0 opacity-0 group-hover:opacity-100 transition-opacity">
